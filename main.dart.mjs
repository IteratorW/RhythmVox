...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      RJ: (x0,x1) => x0.createMediaStreamSource(x1),
      ...
      XH: () => globalThis.Intl,
      XI: (x0,x1) => { x0.buffer = x1 },
      XJ: (x0,x1) => x0.addModule(x1),
      Y: (o0, o1) => [o0, o1],
      ...
      ZH: x0 => x0.index,
      ZI: (x0,x1) => x0.decodeAudioData(x1),
      ZJ: (x0,x1,x2) => new AudioWorkletNode(x0,x1,x2),
      ...
      aH: x0 => x0.next(),
      aI: () => globalThis.webkitAudioContext,
      aJ: x0 => x0.audioWorklet,
      b: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      pH: x0 => x0.deref(),
      pI: x0 => x0.height,
      pJ: () => Symbol("jsBoxedDartObjectProperty"),
