...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      KG: x0 => x0.unicode,
      KH: x0 => x0.document,
      KI: (x0,x1) => x0.decodeAudioData(x1),
      KJ: x0 => x0.pop(),
      L: o => o === undefined,
      ...
      LI: () => globalThis.webkitAudioContext,
      ...
      cG: (x0,x1) => { x0.type = x1 },
      cH: x0 => x0.done,
      cI: x0 => x0.debugSkipFontRetryDelay,
      cJ: x0 => ({audio: x0}),
      d: (o, p) => o[p],
      ...
      dI: (x0,x1,x2) => x0.set(x1,x2),
      dJ: (x0,x1) => x0.getUserMedia(x1),
      e: () => globalThis,
      eB: o => {
        if (o === null || o === undefined) return 0;
      ...
      eH: x0 => x0.iterator,
      eI: x0 => x0.fontFallbackBaseUrl,
      eJ: x0 => x0.mediaDevices,
      ...
      rI: (x0,x1) => x0.getModifierState(x1),
      rJ: x0 => x0.read(),
      s: () => ({}),
      sB: o => {
        if (o === null || o === undefined) return 0;
      ...
      zF: x0 => x0.minHeight,
      zG: x0 => x0.unlock(),
      zH: () => globalThis.navigator.permissions,
      zI: x0 => x0.suspend(),
