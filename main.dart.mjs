...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      CJ: x0 => x0.debugSkipFontRetryDelay,
      CK: x0 => ({audio: x0}),
      ...
      DJ: (x0,x1,x2) => x0.set(x1,x2),
      DK: (x0,x1) => x0.getUserMedia(x1),
      E: (exn) => {
      ...
      HH: x0 => x0.status,
      HI: x0 => x0.localStorage,
      HJ: (x0,x1) => { x0.height = x1 },
      HK: (x0,x1) => x0.query(x1),
      ...
      JJ: x0 => x0.height,
      JK: () => Symbol("jsBoxedDartObjectProperty"),
      K: (exn) => {
      ...
      OI: () => globalThis.navigator.permissions,
      ...
      gI: (x0,x1) => x0.connect(x1),
      gJ: (x0,x1) => x0.removeTrack(x1),
      ...
      iG: (x0,x1) => { x0.name = x1 },
      iH: x0 => x0.buffer,
      iI: (x0,x1) => x0.decodeAudioData(x1),
      iJ: (x0,x1) => x0.warn(x1),
      j: x0 => x0.random(),
      ...
      jH: x0 => x0.wasmMemory,
      jI: () => globalThis.webkitAudioContext,
      jJ: () => globalThis.console,
      k: o => o,
      kB: o => {
        if (o === null || o === undefined) return 0;
      ...
      lJ: (x0,x1) => x0.createMediaStreamSource(x1),
      m: () => globalThis.Math,
      ...
      oI: (x0,x1,x2,x3) => x0.setProperty(x1,x2,x3),
      oJ: x0 => x0.data,
      p: b => !!b,
      ...
      pG: x0 => x0.click(),
      pH: x0 => x0.deref(),
      pI: (x0,x1,x2) => x0.setProperty(x1,x2),
      pJ: (x0,x1) => { x0.onmessage = x1 },
      ...
      sH: a => a.pop(),
      sI: (x0,x1,x2) => x0.setAttribute(x1,x2),
      sJ: x0 => ({parameterData: x0}),
      t: (o, p, v) => o[p] = v,
      ...
      tI: (x0,x1) => x0.appendChild(x1),
      tJ: (x0,x1,x2) => new AudioWorkletNode(x0,x1,x2),
      u: () => [],
